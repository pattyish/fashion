...
?>
                <div class="col-lg-10" style="background:white; height:556px; ">
                    <div class="row">
                        ...
                        <h1 class="page-header">
							 ...
							 <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" id="myBtn">
                              Add More Users
                            </button>
                                    </h1>
                            <?php include'add_user_model.php'; ?> 
                            <?php include'action.php'; ?>
                            <div class="alert alert-info">
                                    <strong><i class="icon-user icon-large"></i>&nbsp;System Users</strong>
                                </div>
    ...
    <tbody>
     <?php
        ...
        <tr>
            ...
            <td style="text-align:center;"><a href="#delete_product<?php echo $id; ?>" role="button"  data-target = "#delete_product<?php echo $id;?>"data-toggle="modal" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Delete</a></td>
        </tr>
        <?php
             $i++;
         }
 ...
 <div class="row">
     <div class="col-md-6"><div class="dataTables_info" id="dataTables-example_info" role="alert" aria-live="polite" aria-relevant="all">Showing 1 to 4 of 4 entries</div></div>
