...
?>
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="height:100px;">
                            ...
                            <div class="alert alert-info">
                                <strong><i class="icon-user icon-large"></i>&nbsp; <i>Message and Suggestion</i></strong>
                                </div>
  ...
  <table class="table table-hover table-striped table-bordered">
    ...
    <tbody>
     <?php
        $i = 1;
        $query = "SELECT * FROM suggestions_table LIMIT 10";
        ...
        <tr>
            <td><?php echo $i; ?></td>
            <td><?php echo $results['firstname'];
              echo "&nbsp;";  
             echo $results['lastname']; ?></td>
            
            <td><?php echo $results['email']; ?></td>
            
            <td><?php echo $results['suggestion']; ?></td>
        </tr>
        <?php
             $i++;
         }
